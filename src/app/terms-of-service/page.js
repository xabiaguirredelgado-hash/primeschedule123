...
Service.</p>
<h2 id="interpretation-and-definitions">Interpretation and
Definitions</h2>
<h3 id="interpretation">Interpretation</h3>
<p>The words whose initial letters are capitalized have meanings defined
...
authority.</p>
<p><strong>Country/State</strong> refers to: Chile</p>
<p><strong>Company</strong> (referred to as either "the Company", "We",
"Us" or "Our" in these Terms and Conditions) refers to primeclips.</p>
<p><strong>Device</strong> means any device that can access the Service
such as a computer, a cell phone or a digital tablet.</p>
<p><strong>Service</strong> refers to the Website.</p>
<p><strong>Terms and Conditions</strong> (also referred to as "Terms")
...
by a third party that is displayed, included, made available, or linked
to through the Service.</p>
<p><strong>Website</strong> refers to primeclips, accessible from <a
href="https://primeclips.onrender.com">https://primeclips.onrender.com</a></p>
...
<p>Your access to and use of the Service is also subject to Our Privacy
...
policies of any third-party websites or services that You visit.</p>
<h3 id="links-from-a-third-party-social-media-service">Links from a
Third-Party Social Media Service</h3>
<p>The Service may display, include, make available, or link to content
...
any Third-Party Social Media Service.</p>
<p>You acknowledge and agree that the Company shall not be responsible
...
these Terms and Your exclusive remedy for all of the foregoing shall be
...
by law.</p>
<h2 id="as-is-and-as-available-disclaimer">"AS IS" and "AS AVAILABLE"
Disclaimer</h2>
...
<p>The laws of the Country/State, excluding its conflicts of law rules,
shall govern these Terms and Your use of the Service. Your use of the
...
resident.</p>
<h2 id="united-states-legal-compliance">United States Legal
Compliance</h2>
...
<h2 id="changes-to-these-terms-and-conditions">Changes to These Terms
and Conditions</h2>
...
contact us:</p>
<ul>
<li><p>By email: primeclipsnxt@gmail.com</p></li>
</ul>
`;
